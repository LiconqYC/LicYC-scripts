...
function lib:Window(text, preset, closebind)
    ...
    TabHold.Position = UDim2.new(0.04, 0, 0.25, 0)
    ...
    function tabhold:Tab(text)
        ...
        function tabcontent:Toggle(text, default, callback)
            ...
            local function updateVisual(state, triggerCallback)
                toggled = state
                if toggled then
                    TweenService:Create(Toggle, TweenInfo.new(.3), {BackgroundColor3 = Color3.fromRGB(37, 37, 37)}):Play()
                    ...
                    TweenService:Create(Toggle, TweenInfo.new(.3), {BackgroundColor3 = Color3.fromRGB(34, 34, 34)}):Play()
            ...
            function toggleObj:Set(bool, callCallback)
                updateVisual(bool, callCallback or false)
            end
        ...
        function tabcontent:Slider(text, min, max, start, callback)
            ...
            local function updateSlider(value, triggerCallback)
                ...
                SlideCircle:TweenPosition(UDim2.new(scale, -6, -1.305, 0), "Out", "Sine", 0.1, true)
            ...
            function sliderObj:Set(val, callCallback)
                updateSlider(val, callCallback or false)
            end
        ...
        function tabcontent:Colorpicker(text, preset, callback)
            ...
            local function updateColorVisual(newColor, triggerCallback)
            ...
            if preset then
                updateColorVisual(preset, false)
            end

            function colorObj:Set(newColor, callCallback)
                updateColorVisual(newColor, callCallback or false)
            end
